...
| messaging-type | The kind of messaging used by the agent. It must be the same domain than the DM. | - | yes |
| domain | The domain. See [Roboconf domains](roboconf-domains.html) for more information. It must be the same domain than the DM. | - | yes |
