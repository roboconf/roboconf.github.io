...
# Install the service
sudo ln -s /home/ubuntu/roboconf-karaf-dist-agent-0.3/bin/roboconf-agent-service /etc/init.d/
...
```properties
# Add the feature URL
feature:repo-add http://repo1.maven.org/maven2/net/roboconf/roboconf-karaf-feature-agent/0.3/roboconf-karaf-feature-agent-0.3-features.xml
