...
# Install the service
sudo ln -s /home/ubuntu/roboconf-karaf-dist-agent-0.4/bin/roboconf-agent-service /etc/init.d/
...
```properties
# Add the feature URL
feature:repo-add http://repo1.maven.org/maven2/net/roboconf/roboconf-karaf-feature-agent/0.4/roboconf-karaf-feature-agent-0.4-features.xml
